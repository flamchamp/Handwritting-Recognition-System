...
int main( int argc, char** argv )
{
  ...
  if ( !__n || ( __n ==  1 ) ) test_case_add_random<Image,ImgFunc,ImgCmp>(1,&mk_1x1,less_intensity);
  if ( !__n || ( __n ==  2 ) ) test_case_copy_random<Image,ImgFunc,ImgCmp>(2,&mk_1x1,less_intensity);

  std::printf("\n Testing with 3x3 images \n");

  if ( !__n || ( __n ==  3 ) ) test_case_add_random<Image,ImgFunc,ImgCmp>(3,&mk_3x3,less_intensity);
  if ( !__n || ( __n ==  4 ) ) test_case_copy_random<Image,ImgFunc,ImgCmp>(4,&mk_3x3,less_intensity);
